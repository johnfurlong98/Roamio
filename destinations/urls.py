...
urlpatterns = [
    ...
    path('destinations-list/', views.DestinationTemplates.as_view({'get': 'get_destination_list'}), name='destinations-list'),
    path('destination-details/<id>', views.DestinationTemplates.as_view({'get': 'get_destination_detail', 'post': 'get_destination_detail'}), name='destination-detail'),
    
    path('destinations-form/', views.DestinationTemplates.as_view({'get': 'get_destination_form', 'post': 'get_destination_form'})),

    path('comments/', views.CommentViewSet.as_view({'get': 'get_queryset', 'post': 'create'})),
    path('comments/<id>', views.CommentViewSet.as_view({'patch': 'partial_update', 'delete': 'delete'})),
